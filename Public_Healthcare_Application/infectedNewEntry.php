...
<html>
<head>
	<title>Insert Infected Data</title>
  <style>
    body {
...
<body>
    ...
    <h2>Insert Data in Infected Table</h2>
    <fieldset>
    <legend>Enter Data to Store</legend>
	<form action="infectedNewEntry.php" method="post">
...
<?php
    if (isset($_POST['Submit'])) {
        ...
        $sql = "INSERT INTO infected (inf_id, medicare_number, date)
        VALUES ('$inf_id', '$medicare_number', '$date')";
