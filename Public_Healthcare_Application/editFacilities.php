...
<head>
    ...
    <title>Facilities Edit New Entry</title>
    <style>
    body {
...
$query = "UPDATE facilities set name = '$name', address = '$address', postal_code = '$postal_code', phone = '$phone', web_address = '$web_address', type = '$type', capacity = '$capacity' where facility_id = '$facility_id'";
