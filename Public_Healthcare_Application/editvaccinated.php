...
<body>
    ...
    <h2>Edit Data in Vaccinated Table</h2>
    <fieldset>
        <legend>Enter Data (vac_id, medicare_number, dose number must be the same)</legend>
...
<?php
    if (isset($_POST['Submit'])) {
       ...
       // Prepare SQL statement
        $sql = "update vaccinated set date = '$day' where medicare_number = '$medicare_number', vac_id = '$vac_id' dose_number = '$dose_number'";
